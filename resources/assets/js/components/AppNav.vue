<template>
    <div class="container d-flex align-items-center justify-content-around px-2 px-md-3 py-2 py-md-3">
        ...
        <transition name="logo">
            <a class="text-main text-large d-block" :href="appHref" :target="appTarget" v-if="!hide">
                {{ appName }}
            </a>
        </transition>
            ...
            <div class="list-group position-absolute w-100 bg-white border rounded box-shadow-lg mt-1"
                ...
                <transition name="fade" mode="out-in">
                    ...
                    <div v-else key="result">
                        <!--分类-->
                        <template v-if="!!cat">
                            <a :href="`/cats/${cat.id}`" @mousedown.prevent
                        ...
                        <!--品牌-->
                        <template v-if="!!brand">
                            <a :href="`/brands/${brand.id}`" @mousedown.prevent
                               class="list-group-item list-group-item-action px-2 px-md-4">
                                <div class="media align-items-center">
                        ...
                        <template v-if="products.length>0">
                            <a :href="`/products/${product.id}`" v-for="product in products"
                        ...
                        <a href="https://www.algolia.com/" @mousedown.prevent
