...
return [
    ...
    */
    ...
    |
    | - isMobile    是否为手机号字段--lebus注:源文件中会返回mobile这个key，所有ismobile为true（可以不管）
    | - enable      是否开启验证
    | - default     默认静态验证规则
    | - staticRules 静态验证规则
    |
    */
    'validation' => [
        'mobile' => [
            ...
            'staticRules' => [
                'mobile_required'     => ['required','regex:/^(13[0-9]|14[579]|15[0-3,5-9]|16[6]|17[0135678]|18[0-9]|19[89])\d{8}$/'],
    ...
    */
    'notifies' => [
        ...
        // 验证码短信发送失败的提示
        'sms_sent_failure' => '短信验证码发送失败，可能是输错了或网络断了',
